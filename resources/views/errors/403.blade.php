...
<body class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        <div class="flex flex-col items-center">
            ...
            <div class="text-8xl font-black bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent mb-2">
                403
            </div>
            <div class="w-16 h-1 bg-gradient-to-r from-orange-400 to-red-500 rounded-full mb-6"></div>
            <div class="text-5xl text-gray-300 mb-4">
                <i class="fas fa-lock"></i>
            </div>
            <h1 class="text-xl font-bold text-gray-800 mb-2">Access Forbidden</h1>
