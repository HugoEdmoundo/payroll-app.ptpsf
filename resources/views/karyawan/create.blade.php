...
<div class="max-w-4xl mx-auto">
    <div class="card p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Add New Karyawan</h1>
            <p class="mt-1 text-sm text-gray-600">Fill in the employee details below</p>
        </div>
        
        <form action="{{ route('karyawan.store') }}" method="POST">
            @csrf
            
            @include('components.karyawan.form', ['karyawan' => null, 'settings' => $settings])
