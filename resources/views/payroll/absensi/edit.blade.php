...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Update attendance record</p>
        </div>
    ...
    <!-- Form Card -->
    <div class="card p-6">
        <form action="{{ route('payroll.absensi.update', $absensi->id_absensi) }}" method="POST">
            @csrf
            @method('PUT')
            
            @include('components.absensi.form', ['absensi' => $absensi, 'karyawanList' => $karyawanList])
