        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Update data kasbon untuk {{ $kasbon->karyawan->nama }}</p>
                </div>
            </div>
        </div>

        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('payroll.kasbon.update', $kasbon->id_kasbon) }}" method="POST">
                @csrf
                @method('PUT')
                
                <x-kasbon.form :kasbon="$kasbon" :karyawanList="$karyawanList" />
