...
@section('title', 'Add Pengaturan Gaji')
@section('breadcrumb', 'Add Pengaturan Gaji')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Add Salary Configuration</h1>
            <p class="mt-1 text-sm text-gray-600">Create new salary configuration template</p>
        </div>
    ...
    <!-- Form Card -->
    <div class="card p-6">
        <form action="{{ route('payroll.pengaturan-gaji.store') }}" method="POST">
            @csrf
            
            @include('components.pengaturan-gaji.form', ['pengaturanGaji' => null, 'settings' => $settings])
